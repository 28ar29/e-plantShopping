...
function ProductList({ onHomeClick }) {
    ...
    const totalQty = useSelector(state => state.cart.items.reduce((s,i)=>s+i.quantity,0));
    ...
    const handleAddToCart = (plant) => {
        ...
        setAddedToCart((prevCart) => {
            // Add plant to cart object with name as key
            return {
                ...prevCart,
                [plant.name]: plant
            };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <span style={{ fontSize: '18px', marginRight: 8 }}>{totalQty}</span>
